...
/*---------------------------------------------------------------------*/
    ...
    for(i=0;i<csgs.length;i++){
        ...
        var csnr = "<li onclick='fadeOut(this)'>"+csmc+"</li>";
...
if(max_kd<91){
    ...
    for(j=0;j<qygsdqmr.length;j++){
        var qymc = qygsdqmr[j];
        var qynr = "<li onclick='fadeOut(this)'>"+qymc+"</li>";
